...
import com.supcon.mes.module_beacon_no_login.SampleGattAttributes;
import com.supcon.mes.module_beacon_no_login.adapter.CharacterAdapter;
import com.supcon.mes.module_beacon_no_login.service.BluetoothLeService;
import com.supcon.mes.module_beacon_no_login.utils.DataTransform;
...
public class DeviceControlActivity extends BaseActivity {
    ...
    boolean updateDeviceId = false;//用来判断改变的是否为id，true的话，就要更新标题中的设备名称。
    ...
    public void getValue(int childPosition, String name) {

        mCommit.setText(getString(R.string.submit) + ":" + name);
