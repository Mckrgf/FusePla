...
public class MyDateUtils {
    ...
    public static final String date_Format9 = "yyyy-MM-dd'T'HH:mm:ss.SSS'Z'";
    public static final int TYPE_THIS_DAYTIME_START = 0;
    public static final int TYPE_THIS_DAYTIME_END = 1;
    ...
    public static Long getTodayZeroPointTimestamps(int type) {
        long result = 0;
        // 获取当天凌晨0点0分0秒Date
...
// 获取当天23点59分59秒Date
        ...
        switch (type) {
            case TYPE_THIS_DAYTIME_START:
                result = beginOfDate.getTime();
                break;
            case TYPE_THIS_DAYTIME_END:
                result = endOfDate.getTime();
                break;
        }
        return result;
