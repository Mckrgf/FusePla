...
-keep class com.app.common_upload.**{*;}

-keep class com.app.com_upload_apt.**{*;}

-keep class com.supcon.mes.module_single_upload.**{*;}

-keep class * implements com.app.common_upload.role.BaseUploadDatabaseUpdater

-keep class * extends com.supcon.mes.middleware.model.bean.CommonUploadDataFetcher

-keep class * extends com.supcon.mes.middleware.controller.BaseSingleUploadController

-keep class * implements com.app.common_upload.entity.BaseVisitor
...
-keep class com.supcon.mes.module_pd.controller.**{*;}