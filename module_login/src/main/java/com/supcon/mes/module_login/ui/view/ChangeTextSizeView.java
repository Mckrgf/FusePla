package com.supcon.mes.module_login.ui.view;
...
public class ChangeTextSizeView extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        text2ScaleX = mText2Paint.measureText(getContext().getString(R.string.login_text_standard));
    ...
    protected void onDraw(Canvas canvas) {
        ...
        //画字
        canvas.drawText(getContext().getString(R.string.login_text_standard), points.get(1).x - text2ScaleX / 2, height / 2 - 50, mText2Paint);
