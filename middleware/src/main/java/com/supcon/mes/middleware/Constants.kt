...
const val SCAN_PERIOD: Long = 7 * 1000                 //BLE单次搜索时间
...
const val KEY_IP = "ip"                         //SP的IP地址的key
const val KEY_PORT = "port"                     //SP的PORT的key
...
const val COUNT_EMPTY_RSSI_LIST = 5                 //默认需要填写的rssi强度列表的数量
